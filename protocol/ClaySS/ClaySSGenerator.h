...
template <class Workload, class Protocol> class ClaySSGenerator : public Worker {
public:
  ...
  ClaySSGenerator(std::size_t coordinator_id, std::size_t id, DatabaseType &db,
  ...
  void start() override {
    ...
    LOG(INFO) << "ClaySSGenerator " << id << " starts.";
