...
#include "protocol/H-Store/HStoreMeta.h"

namespace star {

template <class Workload>
class HStoreManager : public star::Manager {
public:
  ...
  HStoreManager(std::size_t coordinator_id, std::size_t id, const Context &context,
