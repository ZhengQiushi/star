...
template <class Workload, class Protocol> class LionSSMetisGenerator : public Worker {
public:
  ...
  LionSSMetisGenerator(std::size_t coordinator_id, std::size_t id, DatabaseType &db,
  ...
  void start() override {
    ...
    LOG(INFO) << "LionSSMetisGenerator " << id << " starts.";
